    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
        ...
        <Card className="relative overflow-hidden bg-zinc-950/80 border border-white/10 shadow-2xl transition-all hover:-translate-y-1 hover:border-violet-500/50 group !p-0">
          ...
          <div className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-violet-500 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
          <CardHeader className="flex flex-row items-center justify-between p-4 pb-0 relative z-10">
        ...
        <CardContent className="p-0">
          <div className="divide-y divide-white/5">
            ...
            {recentCompanies.map(company => (
              <Link href={`/inquilino/${company.id}`} key={company.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-white/5 transition-colors group block">
