...
export function EditClientDialog({ client, open, onOpenChange, companyType, transportistas }: { client: any, open: boolean, onOpenChange: (open: boolean) => void, companyType?: string, transportistas?: string[] }) {
